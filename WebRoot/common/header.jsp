<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %><%
	String contextPath    = bingo.sso.sso.server.web.WebUtils.getContextPath(request);
	String themeName      = bingo.sso.sso.server.web.WebUtils.getTheme(pageContext.getServletContext());
	String themePath      = contextPath + "/themes/" + themeName;
	String serverViewPath = bingo.sso.sso.server.web.WebUtils.getViewPath(pageContext.getServletContext());
