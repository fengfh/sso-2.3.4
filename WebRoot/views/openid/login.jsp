...
<%@page import="bingo.sso.sso.api.client.ClientHostType"%>
<%@page import="bingo.sso.sso.api.ISingleSignOnContext"%><html>
<head>
	...
	<div class="headerArea">
		<div class="row">
			<div class="span3 offset1">
				<img src="${viewPath}/images/bingo.sso.png" style="height:40px;"/>
