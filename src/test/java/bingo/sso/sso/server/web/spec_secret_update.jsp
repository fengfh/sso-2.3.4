...
<%@page import="bingo.sso.sso.api.appspecifiedsecret.AppSpecifiedSecret"%>
<%@page import="bingo.sso.sso.core.crypto.DES"%>
<%@page import="bingo.sso.sso.core.authentication.password.Md5WithSaltPasswordEncoder"%>
<%@page import="bingo.sso.dao.Dao"%>
<%! 
	int count = 0; 
